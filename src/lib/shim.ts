...
export const shimMirrors: ShimMirror[] = [
  {
    ...
    shims: [
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/ambassador.zip", codename: "ambassador" },
      ...
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/clapper.zip", codename: "clapper" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/coral.zip", codename: "coral" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/corsola.zip", codename: "corsola" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/dedede.zip", codename: "dedede" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/enguarde.zip", codename: "enguarde" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/glimmer.zip", codename: "glimmer" },
      ...
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/jacuzzi.zip", codename: "jacuzzi" },
      ...
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/octopus.zip", codename: "octopus" },
      ...
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/sentry.zip", codename: "sentry" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/stout.zip", codename: "stout" },
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/strongbad.zip", codename: "strongbad" },
      ...
      { url: "https://dl.darkn.bio/api/raw/?path=/SH1mmer/volteer.zip", codename: "volteer" },
  ...
  },
  {
    ...
    shims: [
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/ambassador.zip", codename: "ambassador" },
      ...
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/clapper.zip", codename: "clapper" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/coral.zip", codename: "coral" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/corsola.zip", codename: "corsola" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/dedede.zip", codename: "dedede" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/enguarde.zip", codename: "enguarde" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/glimmer.zip", codename: "glimmer" },
      ...
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/jacuzzi.zip", codename: "jacuzzi" },
      ...
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/lulu.zip", codename: "lulu" },
      ...
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/octopus.zip", codename: "octopus" },
      ...
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/sentry.zip", codename: "sentry" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/stout.zip", codename: "stout" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/strongbad.zip", codename: "strongbad" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/tidus.zip", codename: "tidus" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/ultima.zip", codename: "ultima" },
      { url: "https://dl.diffusehyperion.com/api/raw/?path=/rma/volteer.zip", codename: "volteer" },
